...
const ProjectData = [
  {
    ...
    name: "React Fitness",
    shortDescription: "Track your daily nutrition and exercise and achieve your fitness goals",
  ...
  },
  {
    ...
    shortDescription: "Test your Harry Potter knowledge and save the Wizarding World in this trivia game",
  ...
  },
  {
    ...
    shortDescription: "Review your favorite (and least favorite) movies alongside other movie buffs",
